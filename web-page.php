    ...
    <div class="container">
      <div class="header_wrapper">
        ...
        <nav>
          ...
          <a href="#page6">get consultation</a>
        </nav>
      </div>
  ...
  <header>
    <div class="container">
      ...
      <div class="main_info_section_wrapper">
        <div class="main_info_text">
          <h1>.UI/UX.</h1>
          <p>Wareframes <span>|</span> Interfaces <span>|</span> Userflow Animated Prototypes <span>|</span> Style Guide
          </p>
          <p class="main_subtitle">Get a friendly user experience with various interface layouts.</p>
          <div class="mobile_info_image">
            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_8o1swj3b.json" background="transparent"
              speed="1" style="width: 90%; height: 90%;" loop autoplay></lottie-player>
          </div>
        </div>
        <div class="main_info_image">
    ...
    <div class="container">
      ...
      <div class="main_info_section_wrapper">
        <div class="main_info_text">
          ...
          <div class="mobile_info_image">
            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_hbp48dhz.json" background="transparent"
              speed="1" style="width: 90%; height: 90%;" loop autoplay></lottie-player>
          </div>
        </div>
        <div class="main_info_image">
