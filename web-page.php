...
*/
  ...
  wp_register_style('web-styles', get_template_directory_uri().'/css/web.css', '', '0.0000', false);
...
?>
        ...
        <div class="container">
          ...
          <div class="main_info_section_wrapper">
            <div class="main_info_text">
              <h1>.Get your new <br> fresh-looking visual.</h1>
              <p>Our team will turn your ideas into a professional-looking web design.</p>
              <div class="mobile_info_image">
                <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_claxxda0.json"
                  background="transparent" speed="1" style="width: 90%; height: 90%;" loop autoplay></lottie-player>
              </div>
              <a href="#form">CONTACT US NOW</a>
            </div>
  ...
  <div class="section web_page_2 text_correction">
    <header>
    <div class="container">
      <div class="header_wrapper">
        <div class="header_logo">
      ...
      <div class="main_info_section_wrapper">
        <div class="main_info_text">
          <h1>.UI/UX.</h1>
          <p>Warframes <span>|</span> Interfaces <span>|</span> Userflow Animated Prototypes <span>|</span> Style Guide</p>
          <p class="main_subtitle">Get a friendly user experience with various interface layouts.</p>
          <div class="mobile_info_image">
            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_8o1swj3b.json"  background="transparent"  speed="1"  style="width: 100%; height: 100%;"  loop  autoplay></lottie-player>
          </div>
        </div>
        <div class="main_info_image">
          <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_8o1swj3b.json"  background="transparent"  speed="1"  style="width: 100%; height: 100%;"  loop  autoplay></lottie-player>
  ...
  <div class="section web_page_3 text_correction">
    <header>
    <div class="container">
      <div class="header_wrapper">
        <div class="header_logo">
      ...
      <div class="main_info_section_wrapper">
        <div class="main_info_text">
          <h1>.Mobile app.</h1>
          <p>For smartphones, tablets, smart watches <br> on iOS and Android</p>
          <p class="main_subtitle">Precise design on every screen.</p>
          <div class="mobile_info_image">
            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_hbp48dhz.json"  background="transparent"  speed="1"  style="width: 100%; height: 100%;"  loop  autoplay></lottie-player>
          </div>
        </div>
        <div class="main_info_image">
          <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_hbp48dhz.json"  background="transparent"  speed="1"  style="width: 100%; height: 100%;"  loop  autoplay></lottie-player>
    ...
    <header>
        <div class="container">
          ...
          <div class="price_screen">
            ...
            <p class="price_text">*services may vary depending on your needs and may be discussed with sales manager</p>
          </div>
        </div>
      </header>
      <div class="ticker_section">
        ...
        <div class="container">
          ...
          <div class="portfolio_wrapper">
            ...
            <div class="portfolio_btns">
              ...
              <button class="filter_btn active" data-tab="#tab_3">web design</button>
            </div>
